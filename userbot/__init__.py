...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/userbot/Reforestation/master/DEVS.json"
    )
...
while 0 < 6:
    _BLACKLIST = get(
        "https://raw.githubusercontent.com/userbot/Reforestation/master/ayiinblacklist.json"
    )
